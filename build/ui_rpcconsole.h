...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "XSCOIN - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the XSCOIN debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the XSCOIN-Qt help message to get a list with possible XSCOIN command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        ...
        label_9->setText(QApplication::translate("RPCConsole", "XSCOIN Core", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        openConfigurationfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the XSCOIN configuration file from the current data directory.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
