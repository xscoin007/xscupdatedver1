...
unsigned int nStakeTargetSpacing = 2.30 * 60; // 2.5-minute stakes spacing
...
// xscoin: find block wanted by given orphan block
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        nModifierInterval = 10 * 60; // test modifier interval is 20 minutes
        nCoinbaseMaturity = 10; // test maturity is 10 blocks
        nStakeTargetSpacing = 2.5 * 60; // test block spacing is 5 minutes
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The XSC-NEW Today.. We are in the end game NOW... KAVINCREW@OUTLOOK.COM THE CODER";
        CTransaction txNew;
        txNew.nTime = 1582654891;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1582654891;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ?  1583881415  : 27013;



// uncomment to log block block info        
//      //  start
       if (true && block.GetHash() != hashGenesisBlock )
                      {
                          ...
                          printf("block.nVersion = %u \n", block.nVersion);
                           printf("block.GetHash = %s\n", block.GetHash().ToString().c_str()); 
                                                   //first this, then comment this line out and uncomment the one under.
                        printf("block.hashMerkleRoot = %s \n", block.hashMerkleRoot.ToString().c_str()); 
                                                //improvised. worked for me, to find merkle root
...
//        //end
        ...
        // assert(block.hashMerkleRoot == uint256("0xc10c32f4a5cab0e35042e6bc35cdbaf04a0ff9498e749532f870f6348563d6b4"));
         assert(block.hashMerkleRoot == uint256("0x5c062f21472322a5ca5fd4df1f3b2832dc034f92dc113d4a9170dbb60713508a"));
...
unsigned char pchMessageStart[4] = { 0xf1, 0xfc, 0xc1, 0xfe };
