...
{
    return GetBoolArg("-testnet", false) ? 50848 : 50848;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop XSCOIN server (and possibly override the detachdb config value).");
