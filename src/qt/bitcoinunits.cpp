...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("XSCOINs"));
    case mBTC: return QString(QObject::tr("Milli-XSCOINs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-XSCOINs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
