...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Fri Feb 28 11:59:55 2020
# Project:  qt.pro
# Template: app
...
CXXFLAGS      = -m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wno-unused-local-typedef -Wstack-protector $(DEFINES)
...
/root/coin-src/build/build.h: FORCE
	cd /root/coin-src; /bin/sh share/genbuild.sh /root/coin-src/build/build.h
...
build/qrcodedialog.o: src/qt/qrcodedialog.cpp src/qt/qrcodedialog.h \
		...
		src/qt/guiutil.h \
		src/qt/optionsmodel.h \
		/root/coin-src/src/libqrencode/qrencode.h
